<template>
  <div >
    <div id="slogan" class="text-center" >
      <h1>NameGator</h1>
      <br>
      <h6 class="text-secondary">Gerador de nomes utilizando Vue.js, GraphQL e 
        Node
      </h6>
    </div>
...
export default {
	...
	computed: {
		domains() {
			...
			//https://checkout.hostgator.com.br/?a=add&sld=allairhub&tld=.com&_ga=2.42988517.1314366838.1582297153-1381120062.1580908619
			return domains;
		}
	}
};
